python main.py --kfold 5 --max_seq_length 128 --epochs 5 --n_gpu 2 --gpu_start 2 --per_gpu_batch_size 16 --loss_type 'ce' \
...
python main.py --kfold 5 --max_seq_length 64 --epochs 5 --n_gpu 2 --gpu_start 2 --per_gpu_batch_size 16 --loss_type 'ce' \
